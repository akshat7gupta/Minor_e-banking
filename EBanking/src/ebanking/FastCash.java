...
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash(String pin) {
        ...
        l1.setBounds(235, 140, 700, 35);
        l3.add(l1);

        b1.setBounds(170, 318, 150, 32);
        l3.add(b1);

        b2.setBounds(397, 283, 150, 32);
        l3.add(b2);

        b3.setBounds(170, 353, 150, 32);
        l3.add(b3);

        b4.setBounds(397, 318, 150, 32);
        l3.add(b4);

        b5.setBounds(170, 388, 150, 32);
        l3.add(b5);

        b6.setBounds(397, 353, 150, 32);
        l3.add(b6);

        b7.setBounds(397, 388, 150, 32);
        l3.add(b7);
